...
const Weather = () => {
    ...
    const search = async (city) => {
        ...
        try {
            const url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metic&appid=${import.meta.env.VITE_APP_ID}`;
    ...
    return (
        <div className='weather'>
            <div className='search-bar'>
                <input ref={inputRef} type='text' placeholder='Search' onKeyDown={(event) => {
                    if (event.key === 'Enter') {
